...
| [`property-records-and-map-sources.md`](property-records-and-map-sources.md) | How assessor, permit, MLS, and map sources may accelerate a draft without becoming unsupported measurement claims. |
